...
//    }
    ...
    public void insertAccount(User u) {
        String sql1 = "INSERT INTO [dbo].[User]\n"
                + "           ([email]\n"
                + "           ,[name]\n"
                + "           ,[gender]\n"
                + "           ,[phone]\n"
        ...
        try {
            ...
            stm1.setString(7, u.getPhoto());
            stm1.setString(8, u.getPassword());
            stm1.setBoolean(9, u.isStatus());
            stm1.setInt(10, 5);
            stm1.executeUpdate();
        } catch (Exception ex) {
            System.out.println(ex);
