<%-- 
    Document   : addd
    Created on : Jun 15, 2022, 10:30:56 AM
    Author     : tkoko
--%>
                                ...
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        <div class="d-inline">
                                            ...
                                            <h3 style="margin-left: 150px; margin-top: 30px; color: #00AEEF">Add Feedback</h3>
                                    ...
                                    <div class="card">
                                        <div class="card-block">
                                            <div class="row">
                                                ...
                                                <form method="Post" action="add" enctype="multipart/form-data" style="margin: 50px auto;">
                                                    <table cellpadding="20" cellspacing = "10">
                                                        <tr>
                                                        <input hidden="" type="text" value="${requestScope.orderId}" name="orderId">
                                                    <input hidden="" type="text" value="${requestScope.service.sid}" name="serviceId">
                                                    <td rowspan="2">
                                                    ...
                                                    <td rowspan="2">
                                                        ...
                                                        <br>
                                                        <img src="../${requestScope.service.photo}" alt="photo_service" style="width: 200px" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button style="margin-top: 40px; margin-left: -20px;" class="btn btn-primary waves-effect waves-light" type="submit">Add</button>
