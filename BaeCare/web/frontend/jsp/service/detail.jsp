<%-- 
    Document   : detail.jsp
    Created on : Jun 3, 2022, 9:52:46 AM
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <label>ID</label>
                                                                            <div class="w-inherit form-control">${requestScope.service.sid}</div>
                                                                        </div>
                                                                    </td>
                                                                    <td></td>
                                                                    <td rowspan="2"><img style="width: 350px;" src="../${requestScope.service.photo}"/></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <label>Last Changed</label>
                                                                            <div class="w-inherit form-control">${requestScope.service.updated_date}</div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <label>Service Type</label>
                                                                            <div class="w-inherit form-control">${requestScope.service.st.t_name}</div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <label>Tittle</label>
                                                                            <div class="w-inherit form-control">${requestScope.service.sname}</div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <label>Price</label>
                                                                            <div class="w-inherit form-control">${requestScope.service.original_price}</div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="w-inherit form-control">${requestScope.service.sale_price}</div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <label>Status</label><br>
                                                                            <div class="w-inherit form-control">${requestScope.service.status}</div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="max-textarea form-control">${requestScope.service.details}</div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
