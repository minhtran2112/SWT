                                                ...
                                                <div class="col-lg-4">
                                                    <div class="page-header-breadcrumb">
                                                        <ul class="breadcrumb-title">
                                                            ...
                                                            <li class="breadcrumb-item"><a href="addpost">Create New Post</a> </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="card-header">
                                                            <form action="addpost" method="post" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <select name="authorID" class="form-control">
                                                                            ...
                                                                            <c:forEach items="${requestScope.listAuthor}" var="a">
                                                                                <option value="${a.id}">${a.nameAuthor}</option>
                                                                            </c:forEach>
                                                                        </select>                                                                  
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="date" name="date" class="form-control" placeholder="Type post date" required>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                ...
                                                                <h5>Post Detail</h5>
                                                                <textarea id="mytextarea" name="detail"></textarea><br>
