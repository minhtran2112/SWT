                                                ...
                                                <div class="col-lg-4">
                                                    <div class="page-header-breadcrumb">
                                                        <ul class="breadcrumb-title">
                                                            ...
                                                            <li class="breadcrumb-item"><a href="postslist">Posts List</a> </li>
                                                        ...
                                                        <div class="card-header">
                                                            <form action="editpost" method="post" enctype="multipart/form-data">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <div type="text" class="form-control">${requestScope.post.postID}</div>
                                                                        <input type="hidden" name="postid" class="form-control" value="${requestScope.post.postID}">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <select name="categoryID" class="form-control">
                                                                            <c:forEach items="${requestScope.listCategory}" var="c">
                                                                                <option ${(c.id == requestScope.post.category.id)?"selected=\"selected\"":"" } value="${c.id}">${c.nameCategory}</option>
                                                                            </c:forEach>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <select name="authorID" class="form-control">
                                                                            <c:forEach items="${requestScope.listAuthor}" var="a">
                                                                                <option ${(a.id == requestScope.post.author.id)?"selected=\"selected\"":"" } value="${a.id}">${a.nameAuthor}</option>
                                                                            </c:forEach>
                                                                        </select>                                                              
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" name="title" class="form-control" value="${requestScope.post.postTitle}" required>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="date" name="date" class="form-control"  value="${requestScope.post.postDate}" required>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <select name="status" class="form-control">
                                                                            <option ${(requestScope.post.onHomepage eq "true")?"selected=\"selected\"":"" } value="on">On</option>
                                                                            <option ${(requestScope.post.onHomepage eq "false")?"selected=\"selected\"":"" } value="off">Off</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        ...
                                                                        <img src="../${requestScope.post.postImg}" alt="post_photo" style="max-width: 950px">
                                                                    </div>
                                                                </div>

                                                                <h5>Post Detail</h5>
                                                                <textarea id="mytextarea" name="detail">${requestScope.post.postDetail}</textarea><br>
