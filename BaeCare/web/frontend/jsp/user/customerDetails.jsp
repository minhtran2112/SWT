                                                                                ...
                                                                                <table class="table m-0">
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><div><c:if test="${requestScope.customer.status eq true}">On</c:if>
                                                                                                    <c:if test="${requestScope.customer.status eq false}">Off</c:if></div>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                                    ...
                                                                                    <div class="col-sm-12 col-xl-2">
                                                                                        <a href="editcustomer?email=${requestScope.customer.email}" class="btn btn-primary">Edit Status of Customer </a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
